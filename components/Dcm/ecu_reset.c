...
void hard_reset(UDS_Packet *rx, u8 *resp_data, u16 *idx)
{
  /* Reset the micro-controller? This sounds like a job for the HAL layer, perhaps */
}
void key_off_on_reset(UDS_Packet *rx, u8 *resp_data, u16 *idx)
{
  /* STUB */
}

void soft_reset(UDS_Packet *rx, u8 *resp_data, u16 *idx)
{
  /* STUB */
}

void enable_rapid_power_shutdown(UDS_Packet *rx, u8 *resp_data, u16 *idx)
{
  /* STUB */
}

void disable_rapid_power_shutdown(UDS_Packet *rx, u8 *resp_data, u16 *idx)
{
  /* STUB */
}
