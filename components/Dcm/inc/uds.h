/**
 * @file UDS.h
 * @brief Header file for Unified Diagnostic Services (UDS) module.
 * @author Somen Das
 * @date 2023
 */
...
#include "common.h"
  ...
  enum SID_CODES
  {
    ...
    SID_SECURITY_ACCESS_SERVICE = 0x27,
  ...
  extern u8 resp_data[4096];

  /**
   * @brief Generates a UDS packet.
   * @param SID The required SID code for the operation.
   * @param data Pointer to a u8 array containing relevant UDS data.
